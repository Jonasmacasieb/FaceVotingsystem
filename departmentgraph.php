                    ...
                    Object.keys(departmentData)
                        ...
                        .forEach(function(department, index) {
                            var departmentDataset = {
                                ...
                                data: [], // Initialize an array to store section vote counts
                                backgroundColor: randomColors[index], // Use random color
                                borderColor: 'rgba(75, 192, 192, 1)', // Border color remains the same
                                borderWidth: 1
                            };

                            // Loop through all sections for this department
                            Object.values(departmentData[department]).forEach(function(sectionData) {
                                // If the department has votes for this section, use the vote count; otherwise, use 0
                                departmentDataset.data.push(sectionData.has_voted || 0);
                            });
